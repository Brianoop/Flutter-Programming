...
class RadialExpansionDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    timeDilation = 5.0;
    return Scaffold(
      appBar: AppBar(title: Text('Radial Expansion Animation'),)
      ,body: Container(
        ...
        child: Row(
          ...
          children: [
            _buildHero(context, 'assets/apple.jpeg', 'Apple'), 
            _buildHero(context, 'assets/banana.jpeg', 'Banana'), 
            _buildHero(context, 'assets/eggs.jpeg', 'Eggs'), 
